...
class ChupetaLessonScreen extends StatefulWidget {
  ...
  @override
  State<ChupetaLessonScreen> createState() =>
      _ChupetaLessonScreen();
}

class _ChupetaLessonScreen
    extends State<ChupetaLessonScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    WarnCard(text: "Evite o surgimento de maloclusões e alterações na respiração de seu filho!")
                  ],
                ),
              )),
