...
class MitosCrencasLessonScreen extends StatefulWidget {
  ...
  @override
  State<MitosCrencasLessonScreen> createState() =>
      _MitosCrencasLessonScreen();
}

class _MitosCrencasLessonScreen
    extends State<MitosCrencasLessonScreen> {
        ...
        children: [
          ...
          Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    WarnCard(text: "Alguns aspectos devem ser observados quanto a utilização de"
