...
class PreEclampsiaLessonScreen extends StatefulWidget {
  ...
  @override
  State<PreEclampsiaLessonScreen> createState() =>
      _PreEclampsiaLessonScreen();
}

class _PreEclampsiaLessonScreen
    extends State<PreEclampsiaLessonScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    InfoCardWidget(
                      title: "",
                      content:
                      "Na mãe pode causar edema e hemorragia cerebral, "
