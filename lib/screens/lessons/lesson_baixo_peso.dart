...
class BaixoPesoLessonScreen extends StatefulWidget {
  ...
  @override
  State<BaixoPesoLessonScreen> createState() => _BaixoPesoLessonScreen();
}

class _BaixoPesoLessonScreen extends State<BaixoPesoLessonScreen> {
            ...
            child: Center(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset(
                    'assets/peso_bebe.webp',
                    width: 200,
                    height: 200,
                  ),
                  WarnCard(
                      text:
                          "O baixo peso ao nascer é considerado como um importante problema de saúde "
