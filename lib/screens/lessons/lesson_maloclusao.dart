...
class MaloclusaoLessonScreen extends StatefulWidget {
  ...
  @override
  State<MaloclusaoLessonScreen> createState() =>
      _MaloclusaoLessonScreen();
}

class _MaloclusaoLessonScreen
    extends State<MaloclusaoLessonScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Image.asset('assets/mordida_aberta.webp', width: 300, height: 300,)
                  ],
                ),
              )),
          Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Image.asset('assets/mordida_cruzada.webp', width: 200, height: 200,),
                    InfoCardWidget(
                      title: "Apinhamento dentário",
                      content:
                      "Ocorre devido à falta de espaço para a erupção dos dentes permanentes ",
                    ),
                    Image.asset('assets/apinhamento.webp', width: 200, height: 200,),
                  ],
                ),
              )),
          Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Image.asset('assets/classe_2.webp', width: 200, height: 200,),
                    InfoCardWidget(
                      title: "Mordida profunda",
                      content:
                      "Maloclusão caracterizada pelo cobrimento dos dentes inferiores pelos dentes superiores",
                    ),
                    Image.asset('assets/mordida_profunda.webp', width: 200, height: 200,),
                  ],
                ),
              )),
          Center(
