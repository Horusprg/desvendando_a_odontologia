...
class SaudeBucalLessonScreen extends StatefulWidget {
  ...
  @override
  State<SaudeBucalLessonScreen> createState() => _SaudeBucalLessonScreen();
}

class _SaudeBucalLessonScreen extends State<SaudeBucalLessonScreen> {
            ...
            child: Center(
              ...
              child: Column(
                children: [
                  ...
                  InfoCardWidget(
                    title: "",
                    content: "Aumento dos níveis de inflamação periodontal;",
                  ),
                  InfoCardWidget(
                    title: "",
                    content: "Doença cárie.",
                  ),
                  InfoCardWidget(
                    title: "",
                    content:
            ...
            child: Center(
              ...
              child: Column(
                children: [
                  ...
                  WarnCard(
                      text:
                          "Os hormônios sexuais femininos têm um importante papel nas alterações periodontais. ")
                ],
              ),
            )),
          ),
