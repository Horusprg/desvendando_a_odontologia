...
class DesmameLessonScreen extends StatefulWidget {
  ...
  @override
  State<DesmameLessonScreen> createState() =>
      _DesmameLessonScreen();
}

class _DesmameLessonScreen
    extends State<DesmameLessonScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    InfoCardWidget(
                      title: "",
                      content:
                      "A utilização de bicos artificiais",
                    ),
                    InfoCardWidget(
                      title: "",
                      content:
                ...
                child: Column(
                  children: [
                    InfoCardWidget(
                      ...
                      content:
                      "A criança teve dificuldade para pegar o peito;",
                    ),
                    InfoCardWidget(
                      title: "",
                      content:
                      "Dor nos seios e dificuldades ao amamentar;",
                    ),
                    InfoCardWidget(
                      title: "",
                      content:
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Garantia do trabalho durante o período de gestação e lactação"),
                    Text("Direito à creche"),
                    Text("Direito a pausas periódicas para amamentar"),
                    Text("Alojamento conjunto para a lactante e lactente permaneçam juntos em hospitais e maternidades vinculadas ao SUS"),
                    Text("Normas brasileira que regulamentam a comercialização de alimentos para lactentes e Crianças na primeira Infância, bicos, chupetas e mamadeiras "),
                  ],
                ),
              )),
          Center(
                ...
                child: Column(
                  children: [
                    InfoCardWidget(
                      title: "Mitos/crenças",
                      content:
                      "Os seios ficam muito caídos",
                    ),
                    InfoCardWidget(
                      title: "",
                      content:
                      "Apenas o leite materno não sustenta",
                    ),
                    InfoCardWidget(
                      title: "",
                      content:
                    ...
                    InfoCardWidget(
                      title: "",
                      content:
                      "Maisena, leite e chás ajudam a sustentar o bebê",
                    ),
                ...
                child: Column(
                  children: [
                    InfoCardWidget(
                      ...
                      content:
                      "A amamentação não faz os peitos caírem",
                    ),
                    InfoCardWidget(
                      title: "",
                      content:
          ...
          Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    InfoCardWidget(
                      title: "Em casos de cólicas é necessário dar um chá de coentro ou outro para alívio no bebê.",
                      content:
