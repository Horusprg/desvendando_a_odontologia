...
class _PartoPrematuroLessonScreen
    extends State<PartoPrematuroLessonScreen> {
          ...
          Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    InfoCardWidget(
                      title: "Quais as principais complicações causadas pela prematuridade e o baixo peso ao nascer?",
                      content:
                      "",
                    ),
                    InfoCardWidget(
